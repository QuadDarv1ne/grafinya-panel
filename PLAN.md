...
**Статус:** Готово ✓ (useTranslation hook, LanguageSwitcher, 43 теста)
...
**Статус:** Готово ✓ (AppHeader, AppSidebar, MobileSidebar вынесены в отдельные компоненты)
...
**Статус:** Готово ✓ (manifest + Service Worker для кэширования статики)
